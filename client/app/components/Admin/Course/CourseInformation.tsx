...
const CourseInformation:FC<Props> = ({ courseInfo, setCourseInfo, active, setActive} ) => {
  ...
  return (
    <div className='w-[805] m-auto mt-24'>
        <form onSubmit={handleSubmit} className={`${styles.label}`}>
           ...
           <input 
               ...
               onChange={(e: any) => setCourseInfo
                ({...courseInfo, tags:e.target.value})
               }
               id='name'
               placeholder='MERN,NEXT 3, Socket io,tailwind,css,LMS'
               className={`${styles.input}`}
             ...
             />
              ...
              <label className={`${styles.label} w-[50%]`}>
               ...
               <select
            className={`${styles.input} bg-[#111827] text-white border border-gray-700`}
          ...
          >
           ...
           <input 
             ...
             <div className="w-full">
              ...
              <label htmlFor="file"
              className={`w-full min-h-[10v] dark:border-white border-[#00000026] p-3 border flex items-center justify-center ${
             ...
             <div className="w-full flex items-center justify-end">
              ...
              type='submit'
              value="Next"
              className='w-full 800:w-[180px] h-[40px] bg-[#37a39a] text-[#fff] rounded mt-8 cursor-pointer' 
              />
             </div>
